...
<html>
	...
	<body>
		...
		<div style="text-align: center;">
			 <div id="formwrapper">
      <h3>查询条件</h3>
         <form action="./servlet/ProjectServlet?methodName=selectProject" method="post" name="" id="">
        <fieldset>
          ...
          <div>
            ...
            <select name="select">
            	...
            	<option value="institution">被测单位</option>
            	<option value="level">安全保护等级</option>
            	<option value="funds">项目经费</option>
            	<option value="manager">项目经理</option>
            	<option value="phonenum">联系电话</option>
