...
<html>
	...
	<body>
		...
		<div style="text-align: center;">
			 <div id="formwrapper">
      <h3>查询条件</h3>
         <form action="./servlet/TaskServlet?methodName=selectTask" method="post" name="" id="">
        <fieldset>
          ...
          <div>
            ...
            <select name="select">
            	...
            	<option value="earperson">前期人员</option>
            	<option value="midperson">中期人员</option>
            	<option value="lateperson">后期人员</option>
